...
def testMethodAdd():
    ...
    for key in testCaseAddMethod.keys():
        ...
        try:
            ...
            actual=PFAssgn1.add(inputvalue[0],inputvalue[1])
            #print(actual)
...
def testMethodSub():
    ...
    for key in testCaseSubMethod.keys():
        ...
        try:
            ...
            actual=PFAssgn1.sub(inputvalue[0],inputvalue[1])
            #print(actual)
            if actual == expectedResult:
                logicVal.actual=actual
                logicVal.isPassed=True
...
def testMethodMult():
    ...
    for key in testCaseMultMethod.keys():
        ...
        try:
            ...
            actual=PFAssgn1.mult(inputvalue[0],inputvalue[1])
            #print(actual)
            if actual == expectedResult:
                logicVal.actual=actual
                logicVal.isPassed=True
...
def testMethodDiv():
    ...
    for key in testCaseDivMethod.keys():
        ...
        try:
            ...
            actual=PFAssgn1.div(inputvalue[0],inputvalue[1])
            #print(actual)
            if actual == expectedResult:
                logicVal.actual=actual
                logicVal.isPassed=True
